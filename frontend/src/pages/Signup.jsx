...
const Signup = () => {
  ...
  return (
    ...
    <div className='min-h-[79vh]'>
      ...
      <form className="signup max-w-md mx-auto p-8 bg-white shadow-lg rounded-lg my-10" onSubmit={handleSubmit}>
        <h3 className="text-2xl font-semibold mb-6 text-gray-700">Sign up</h3>
